...
import 'package:calender_new/utils/custom_app_bar.dart';
import 'package:calender_new/utils/text_styles.dart';
            ...
            child: Container(
              ...
              child: TableCalendar<Event>(
                ...
                headerStyle: HeaderStyle(
                    ...
                    titleCentered: true,
                    titleTextStyle:
                        const TextStyle(fontSize: 16, color: AppColors.kBlackColor),
                    decoration: BoxDecoration(
                      color: AppColors.kWarningToastBgColor.withOpacity(.2),
                ...
                calendarStyle: CalendarStyle(
                    ...
                    todayDecoration: BoxDecoration(
                      color: AppColors.kMale.withOpacity(0.6),
                      ...
                      child: Container(
                        decoration: _selectedDay == day
                            ? BoxDecoration(
                                ...
                                border: Border.all(color: AppColors.kMale),
                                shape: BoxShape.circle,
                              )
                            : const BoxDecoration(
              ...
              child: Row(
                ...
                children: [
                  Image.asset("assets/icons/ic_date.png",
                      height: 12, color: AppColors.kBlackColor.withOpacity(.6)),
